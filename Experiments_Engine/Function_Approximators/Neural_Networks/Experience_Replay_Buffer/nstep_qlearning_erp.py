...
from Experiments_Engine.RL_Agents.nstep_qlearning_return import nStep_QLearning_ReturnFunction
from Experiments_Engine.Util.utils import check_attribute_else_default
from Experiments_Engine.config import Config


class nStep_QLearning_ExperienceReplay:
    ...
    def __init__(self, config, return_function):
        ...
        assert isinstance(return_function, nStep_QLearning_ReturnFunction)
