...
do
    ...
    python3.6 /home/jfernando/PycharmProjects/RL_Experiments/Experiments/Deep_QSigma_MC/dqsigman_mc.py -episodes 500 -n 20 -sigma 1 -beta 1 -dump_agent -target_epsilon 0.1 -compute_bprobabilities -name Sarsa_n20/agent_$i
done
