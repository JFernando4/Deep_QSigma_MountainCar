...
do
    ...
    python3 ./Experiments/Deep_QSigma_MC/dqsigman_mc.py -episodes 500 -n 5 -sigma 1 -beta 0.95 -store_sigma \
    -compute_bprobabilities -quiet -dump_agent -target_epsilon 0.1 -name DecayingSigma_n5/agent_$i
done
