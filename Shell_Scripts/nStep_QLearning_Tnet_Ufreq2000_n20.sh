...
do
    ...
    python3 ./Experiments/Deep_nStep_QLearning/deep_nstep_qlearning.py -episodes 500 -n 20 -quiet -dump_agent \
    -tnetwork_update_freq 2000 -name QLearning_Tnet_Ufreq2000_n20/agent_$i
done
