...
do
    ...
    python3 ./Experiments/Deep_QSigma_MC/dqsigman_mc.py  -episodes 500 -compute_bprobabilities\
    -n 10 -sigma 1 -beta 0.99724 -sigma_min 0.5 -store_sigma -quiet -dump_agent -target_epsilon 0.1 \
    -name DecayingSigma_Tuned_n10/agent_$i
done
