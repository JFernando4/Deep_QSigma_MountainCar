...
do
    ...
    python3 ./Experiments/Deep_QSigma_MC/dqsigman_mc.py -episodes 500 -n 20 -sigma 0.5 -beta 1 \
    -quiet -dump_agent -compute_bprobabilities -target_epsilon 0.1 -tnetwork_update_freq 500 \
    -name QSigma0.5_Tnet_Ufreq500_n20/agent_$i
done
