...
do
    ...
    python3 ./Experiments/Deep_QSigma_MC/dqsigman_mc.py -episodes 500 -n 1 -sigma 0 -beta 1 -quiet -dump_agent \
    -target_epsilon 0.0 -anneal_epsilon -name QLearning_wAnnealingEpsilon/agent_$i
done
