...
do
    ...
    python3 ./Experiments/Deep_QSigma_MC/dqsigman_mc.py -episodes 500 -n 20 -sigma 0 -beta 1 \
    -quiet -dump_agent -target_epsilon 0.1 -tnetwork_update_freq 2000 \
    -name TreeBackup_Tnet_Ufreq2000_n20/agent_$i
done
