...
do
    ...
    python3 ./Experiments/Deep_QSigma_MC/dqsigman_mc.py -episodes 500 -n 20 -sigma 1 -beta 0.95 -store_sigma \
    -compute_bprobabilities -quiet -dump_agent -target_epsilon 0.1 -tnetwork_update_freq 500 \
    -name DecayingSigma_Tnet_Ufreq500_n20/agent_$i
done
