...
do
    ...
    python3 ./Experiments/Deep_QSigma_MC/dqsigman_mc.py -episodes 500 -n 3 -sigma 1 -beta 1 -quiet -dump_agent \
     -target_epsilon 0.1 -compute_bprobabilities -name Sarsa_n3/agent_$i
done
